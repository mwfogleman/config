...
(setq inhibit-startup-echo-area-message t) ;; hide splash screen and banner (not relevant in Daemon)
#+end_src
...
** Custom-set variables?
 I'm not sure how to relate custom-set variables to the Org-Babel configuration.
